...
const generateBonusStatementValidationSchema = z.object({
...
const bonusStatementActionValidationSchema = z.object({
  body: z.object({
    note: z.string().trim().optional(),
  }),
});

const bonusStatementBulkActionValidationSchema = z.object({
  body: monthlyBodyBaseSchema.extend({
    note: z.string().trim().optional(),
...
const bonusStatementSummaryQueryValidationSchema = z.object({
  query: z
    .object({
      bonusMonth: bonusMonthSchema.optional(),
      month: z
...
export const BonusStatementValidations = {
  generateBonusStatementValidationSchema,
  bonusStatementActionValidationSchema,
  bonusStatementBulkActionValidationSchema,
  bonusStatementSummaryQueryValidationSchema,
};
