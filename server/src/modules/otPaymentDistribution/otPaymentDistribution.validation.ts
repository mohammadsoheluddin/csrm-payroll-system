...
const generateOtPaymentDistributionValidationSchema = z.object({
  body: z.object({
    month: monthSchema,
    year: yearSchema,
...
const otPaymentDistributionActionValidationSchema = z.object({
  params: z.object({
    id: objectIdSchema("OT Payment Distribution id"),
  }),
  body: z
    .object({
      note: noteSchema,
...
const otPaymentDistributionBulkActionValidationSchema = z.object({
  body: z
    .object({
