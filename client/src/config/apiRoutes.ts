export const apiRoutes = {
  ...
  attendanceFinalizations: {
    root: '/attendance-finalizations',
    generate: '/attendance-finalizations/generate',
    summary: '/attendance-finalizations/summary',
    finalize: (id: string) => `/attendance-finalizations/${id}/finalize`,
    approve: (id: string) => `/attendance-finalizations/${id}/approve`,
    lock: (id: string) => `/attendance-finalizations/${id}/lock`,
    unlock: (id: string) => `/attendance-finalizations/${id}/unlock`,
    bulkFinalize: '/attendance-finalizations/bulk/finalize',
    bulkApprove: '/attendance-finalizations/bulk/approve',
    bulkLock: '/attendance-finalizations/bulk/lock',
    bulkUnlock: '/attendance-finalizations/bulk/unlock',
  },
  leave: {
    root: '/leave',
