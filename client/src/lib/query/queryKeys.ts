export const queryKeys = {
  ...
  employeeDocuments: {
    ...
    list: (mode: string, params?: Record<string, unknown>) =>
      ['employee-documents', 'list', mode, params ?? {}] as const,
    byEmployee: (employeeId: string, params?: Record<string, unknown>) =>
      ['employee-documents', 'employee', employeeId, params ?? {}] as const,
    summary: (employeeId: string) => ['employee-documents', 'summary', employeeId] as const,
  },
  attendance: {
  ...
  audit: {
    ...
    timeline: (params?: Record<string, unknown>) => ['audit', 'timeline', params ?? {}] as const,
    filterOptions: (params?: Record<string, unknown>) => ['audit', 'filter-options', params ?? {}] as const,
    sensitive: (params?: Record<string, unknown>) => ['audit', 'sensitive', params ?? {}] as const,
    detail: (id: string) => ['audit', 'detail', id] as const,
    rbacSummary: (params?: Record<string, unknown>) => ['audit', 'rbac-summary', params ?? {}] as const,
    rbacModules: (params?: Record<string, unknown>) => ['audit', 'rbac-modules', params ?? {}] as const,
    rbacPermissions: (params?: Record<string, unknown>) => ['audit', 'rbac-permissions', params ?? {}] as const,
    rbacRoles: (params?: Record<string, unknown>) => ['audit', 'rbac-roles', params ?? {}] as const,
    rbacMatrix: (params?: Record<string, unknown>) => ['audit', 'rbac-matrix', params ?? {}] as const,
    rbacCoverage: (params?: Record<string, unknown>) => ['audit', 'rbac-coverage', params ?? {}] as const,
    rbacRouteCoverage: (params?: Record<string, unknown>) => ['audit', 'rbac-route-coverage', params ?? {}] as const,
  },
} as const
