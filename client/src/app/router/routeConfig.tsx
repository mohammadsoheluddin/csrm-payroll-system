...
export const appRouteConfig: AppRouteConfigItem[] = [
  ...
  },
  {
    ...
    description: 'Inspect system audit trail, filters, status changes, and sensitive actions.',
    section: 'Reports & Control',
  ...
  },
  {
    ...
    description: 'Review RBAC summary and coverage using backend sub-route patterns.',
    section: 'Reports & Control',
